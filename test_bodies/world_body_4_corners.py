...
pd[x + 6, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C2_Z.matrix @ TAG_POINTS.T).T[:4, :3]
pd[x + 7, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C2_X.matrix @ TAG_POINTS.T).T[:4, :3]
pd[x + 8, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C2_Y.matrix @ TAG_POINTS.T).T[:4, :3]
pd[x + 9, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C1_Y.matrix @ TAG_POINTS.T).T[:4, :3]
pd[x +10, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C1_X.matrix @ TAG_POINTS.T).T[:4, :3]
pd[x +11, 0], pd[x + 5, 1], pd[x + 5, 2], pd[x + 5, 3] = (C1_Z.matrix @ TAG_POINTS.T).T[:4, :3]
